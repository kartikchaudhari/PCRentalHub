<body>
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="<?=base_url();?>" title="Home"><i class="fa fa-home home_1"></i></a> / <span>Frequently Asked Question</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	<!-- Faq -->
	<div class="faq main-grid-border">
		<div class="container">
			<h2 class="w3-head" align="center">Frequently Asked Question</h2>
			<hr>
			<dl class="faq-list">
				<dt class="faq-list_h">
